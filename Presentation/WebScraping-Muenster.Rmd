...
- Folien sind online verfügbar: https://github.com/FabianFox/Webscraping-Muenster-/
...
```{r studi_df, echo = TRUE, eval = TRUE}
# empfohlen
...
- Schleifen mit purrr ([Cheatsheet](https://www.rstudio.com/resources/cheatsheets/#purrr), [Wickham & Grolemund 2017](https://r4ds.had.co.nz/iteration.html)) 
...
Kombination von statischem und dynamischen Teil:
